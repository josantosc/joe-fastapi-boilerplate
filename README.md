...
```bash
copier copy https://github.com/josantosc/joe-fastapi-boilerplate my-awesome-project --trust
```

If you have `pipx` and you didn't install `copier`, you can run it directly:

```bash
pipx run copier copy https://github.com/josantosc/joe-fastapi-boilerplate my-awesome-project --trust
```
